 ...
 * Provides a styled, accessible checkbox with support for custom classes and props.
 * Uses Lucide's CheckIcon for the indicator.
 * 
 ...
 * Checkbox component.
 *
 * @param {object} props - Props extending CheckboxPrimitive.Root props.
