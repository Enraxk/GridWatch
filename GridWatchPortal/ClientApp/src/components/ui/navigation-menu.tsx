/**
 * @fileoverview
 * UI components for a navigation menu using Radix UI primitives.
 * Provides styled wrappers for navigation menu elements such as Root, List, Item, Trigger, Content, Viewport, Link, and Indicator.
 * Utilizes class-variance-authority for style management and utility functions for class name composition.
 * Designed for use in React applications with TypeScript.
 */
...
/**
 * Styles for the navigation menu trigger.
 */
 ...
 * Button to open/close a navigation menu item.
 *
 * @param {object} props - Component props.
 * @param {string} [props.className] - Additional class names.
 * @param {React.ReactNode} props.children - Child components.
 ...
 * Content area for a navigation menu item.
 *
 * @param {object} props - Component props.
 * @param {string} [props.className] - Additional class names.
 */
 ...
 * Viewport for displaying navigation menu content.
 *
 * @param {object} props - Component props.
 * @param {string} [props.className] - Additional class names.
 */
 ...
 * Link element for navigation menu items.
 *
 * @param {object} props - Component props.
 * @param {string} [props.className] - Additional class names.
 */
